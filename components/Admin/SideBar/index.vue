        ...
        <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
                <NuxtLink to="/admin/message"
                          prefetchedClass="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-cyan-700 pr-6"
            ...
            <li>
              ...
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">List des produits</span>
                </NuxtLink>
            </li>
            <li class="px-5">
                <div class="flex flex-row items-center h-8">
