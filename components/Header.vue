...
<!--                    &lt;!&ndash; Mobile Menu open: "block", Menu closed: "hidden" &ndash;&gt;-->
<!--                    <div class="md:flex items-center">-->
<!--                        <div class="flex flex-col md:flex-row md:mx-6">-->
<!--                            <NuxtLink to="/"-->
<!--                                prefetchedClass="my-1 text-md font-bold hover:text-cyan-500 md:mx-4 md:my-0"-->
<!--                                activeClass="text-cyan-500 hover:text-slate-600">Home</NuxtLink>-->
<!--                            <NuxtLink to="/products"-->
<!--                                prefetchedClass="my-1 text-md  font-bold hover:text-cyan-500 md:mx-4 md:my-0"-->
<!--                                activeClass="text-cyan-500">Shop</NuxtLink>-->
<!--                        </div>-->

<!--                        &lt;!&ndash; <div class="flex justify-center md:block">-->
