    ...
    <div class="container">
         <div class="flex flex-row">
               ...
               <div class="basis-2/5 pl-10">
                   <div class="shadow-[0_0px_30px_-15px_gray] w-[190px] pt-[12px] mt-5 mb-10 h-[50px] text-center rounded-[50px]">  Revenir aux resultats</div>
                   ...
                   <div class="mt-5">
                      ...
                      <p class="mt-5 text-[gray] ">Honoraires à la charge de l'acquéreur : 3,92 % TTC | 644 300€ honoraires inclus | 620 000€ hors honoraires | Taxe foncière : 2 501,00€</p>
                ...
                <div class="mt-10 flex">
                    <button class="bg-[#008890] text-white rounded-lg text-xl tracking-wider font-bold h-[60px] w-[200px]">Contacter l'Adresse</button>
                    <button class="text-black rounded-lg text-xl tracking-wider font-bold h-[60px] w-[200px]">Déposer un dossier</button>
                </div>
               </div>
         </div>
         ...
         <div class="flex mt-10 ml-20">
             <div class="basis-1/2 p-5">
                 ...
                 <div class="border rounded-lg p-5">
                    ...
                    <p class="text-xl text-[#008890] font-bold ">Montant estimé des dépenses annuelles d'énergie pour un usage standard :
             ...
             <div class="basis-1/2 shadow-[0_0px_30px_-15px_gray] p-5 rounded-[20px] ">
                 ...
                 <div class="text-white font-bold bg-[#BABDBE] rounded-lg m-2 pl-2 pt-[11px] h-[50px]">Les essentiels</div>
                     <div class="flex">
