...
const createRecord = async () => {
    await useFetch('/api/imo/add', {
        ...
        body: {
            ...
            "nbPiece": parseInt(selectedProduct.nb_piece),
            "nbRoom": parseInt(selectedProduct.nb_room),
            "surface": parseInt(selectedProduct.surface),
                    ...
                    <div class="py-2">
                        <form class="w-full max-w-lg">
                            ...
                            <div class="flex flex-wrap -mx-3 my-5 gap-2 justify-center items-center">
                                <button @click.prevent="createRecord"
